...
<section class="pricing fade-in" id="pricing">
  ...
  <div class="pricing-cards">
    ...
    <div class="price-card" style="border:2px solid #00e676;box-shadow:0 0 30px rgba(0,230,118,0.18);position:relative">
      ...
      <div class="price-amount" style="color:#00e676;text-shadow:0 0 30px rgba(0,230,118,0.5);font-size:3.8rem" data-i18n="pricing.free_trial">GRATIS</div>
      <div style="margin:12px 0 4px;font-size:12px;color:rgba(0,230,118,.7);letter-spacing:1px" data-i18n="pricing.trial_subtitle">&#9733; PARA QUE COMPRUEBES SU EFECTIVIDAD &#9733;</div>
      <ul class="price-list" style="margin-top:20px">
        <li style="color:#a7f3d0" data-i18n="pricing.tr1">Acceso por tiempo ilimitado</li>
      ...
      <a href="https://t.me/BuySell365traiding" target="_blank" style="display:block;width:100%;text-align:center;margin-top:16px;padding:18px 24px;background:linear-gradient(135deg,#00c853,#00e676,#69f0ae);border-radius:14px;color:#000;font-weight:900;font-size:1.15rem;text-decoration:none;cursor:pointer;box-shadow:0 4px 30px rgba(0,230,118,0.5);transition:all .3s"><span data-i18n="pricing.contact_admin">&#128172; Cont&aacute;ctame ahora</span></a>
    </div>
  </div>
</section>
